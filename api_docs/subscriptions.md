...
subscription[third_party_id] | The id of a third party plan. *required* if not using braintree or stripe. <br />**Note**: third_party_id can't have unicode characters in the name. Only alphanumeric characters are allowed (Example: apple123) | String
